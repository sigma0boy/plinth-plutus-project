...
The Cardano open source project `plinth-template` is committed to ensuring the security of
...
If you discover a security vulnerability in `plinth-template`, we encourage you to
responsibly disclose it to us. To report a vulnerability, please use
the [private reporting form on
GitHub](https://github.com/IntersectMBO/plinth-template/security/advisories/new)
...
- The version of `plinth-template` package where the vulnerability exists.
...
form](https://github.com/IntersectMBO/plinth-template/security/advisories/new). Should you experience any issues reporting via GitHub or have other questions, Please contact [Security](security@intersectmbo.org).
...
on the [`plinth-template` repository](https://github.com/IntersectMBO/plinth-template/blob/main/SECURITY.md).
